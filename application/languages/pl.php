...
return array(
    ...
    'Unit and street numbers visible to all' 
        => 'Numer budynku i mieszkania widoczne dla wszystkich',
    ...
    'Approximate min. age of the tenants' 
        => 'Przybliżony minimalny wiek lokatorów',
    'Approximate max. age of the tenants' 
        => 'Przybliżony maksymalny wiek lokatorów',
    'Gender' => 'Płec',
    'Mixed' => 'Mieszana',
    'Male'  => 'Męska',
    'Female' => 'Żeńska',
    ...
    'Smokers accepted' => 'Palący akceptowani',
    'Couples accepted' => 'Pary akceptowane',
    'Kids accepted' => 'Dzieci akceptowane',
    'Pets accepted' => 'Zwierzęta akceptowane',    
    ...
    '\'%value%\' is less than %min% characters long' => '\'%value%\' jest krótsze niż %min% znaków',
    ...
    'If you’ve forgotten or lost your login information' 
        => 'Jeśli zapomniałes jak sie zalogować',
    'If you don’t have an OpenID account, you can get one for free at' 
        => 'Jeśli nie masz konta OpenID, możesz dostać darmowe na',
    'Incorret email (or no email) was returned form OpenID provider' 
        => 'Niepoprawny email (albo jego brak) zostawł zwrócony przez twojego dostawce OpenID',
    ...
    'Number of tenants' => 'Liczba lokatorów',
    ...
    'Cannot change accommodation type?' => 'Nie moge zmienić typu?',
    ...
    'Lokalization on the map was changed' 
        => 'Lokalizacja na mapie została zmieniona',
    'offer' => 'ofertę',
    ...
    'Is short term OK (less than 2 months)' 
        => 'Pobyt na krótko (krótszy niż 2 miesiace) jest akceptowany',
    'Accommodation advert preview' => 'Podgląd oferty',
    'Read more' => 'Zobacz więcej',
    'Close' => 'Zamknij',
    'Minimum tenancy [month]' => 'Minimalny pobyt [mies.]',
    'Save' => 'Zapisz',
    'No accommodetion were found with the selected criteria' 
        => 'Nie znaleziono ofert o podanych kryteriach',
    'Home' => 'Strona główna',
    'Full map view' => 'Pełny widok na mapie',
    'Map' => 'Mapa',
    'City must be specified' => 'Miasto musi by określone',
    ...
    "This user registered directly in our system.  If you are this user please try to %login% using your email and password." => 
      "Ten użytkownik zarejstrowal się bezpośrednio w naszym system. Jestli to ty, sprobój się %login% używajac twój adres email i hasło.",
    ...
    'Such as electricity, gas, Internet' 
        => 'Jak na przykład elektryczność albo ogrzewanie',
